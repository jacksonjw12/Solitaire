...
module.exports = {
  entry: './client/index.ts', // Entry point of your TypeScript application
  output: {
  ...
  plugins: [
    new HtmlWebpackPlugin({
        template: './client/index.html', // Your custom template
    }),
  ],
  resolve: {
  ...
  module: {
    ...
    //     include:'/node_modules/json-stable-stringify', // Include dependencies
    // },
    {
        test: /\.tsx?$/, // Apply this rule to .ts and .tsx files
        use: 'ts-loader', // Use ts-loader to transpile TypeScript
